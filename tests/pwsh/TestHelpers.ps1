# TestHelpers.ps1
# Shared setup for delphi-dccbuild Pester tests.
#
...
#
# Provides:
#   Get-ScriptUnderTestPath  - absolute path to delphi-dccbuild.ps1
...
# Named alias used in delphi-dccbuild.Tests.ps1 for readability.
function Get-DccBuildScriptPath { Get-ScriptUnderTestPath }
